  ...
  useEffect(() => {
    const mockDashboards: Dashboard[] = [
      ...
      },
      {
        ...
        description: 'Real-time sales data and performance analytics',
        theme: 'light',
        refresh_interval: 60,
        active: true,
      ...
      <div className="main-content" style={{ margin: '0 auto', width: '90%', maxWidth: 1400, padding: '20px 0' }}>
        <div className="top-nav-bar" style={{ 
          ...
          <div className="nav-center">
            <h1 style={{ margin: 0, fontSize: '24px', fontWeight: '600' }}>Dashboard Builder</h1>
          </div>
        ...
        <div className="content-area">
          <div className="section-header" style={{ marginBottom: '20px' }}>
            <h2 style={{ margin: 0, fontSize: '20px', fontWeight: '500' }}>Your Dashboards</h2>
            <p style={{ margin: '8px 0 0 0', opacity: 0.7 }}>Create and manage interactive data dashboards</p>
          </div>
          ...
          {loading ? (
            <div className="loading" style={{ textAlign: 'center', padding: '40px' }}>
              ...
              <p style={{ marginTop: '16px', opacity: 0.7 }}>Loading dashboards...</p>
            </div>
          ) : (
            <div className="dashboards-list" style={{
              display: 'grid',
              gridTemplateColumns: 'repeat(auto-fill, minmax(350px, 1fr))',
              gap: '20px'
            }}>
              {dashboards.map(dashboard => (
                <div key={dashboard.id} className="dashboard-card" style={{
                  background: 'rgba(255, 255, 255, 0.05)',
                  border: '1px solid rgba(255, 255, 255, 0.1)',
                  borderRadius: '12px',
                  padding: '20px',
                ...
                >
                  <div className="dashboard-header" style={{ marginBottom: '15px' }}>
                    <h3 style={{ margin: 0, fontSize: '18px', fontWeight: '600' }}>{dashboard.dashboard_name}</h3>
                  ...
                  <div className="dashboard-details" style={{ marginBottom: '15px' }}>
                    <div style={{ fontSize: '13px', opacity: 0.7 }}>
                      Refresh: <span style={{ opacity: 0.9 }}>{dashboard.refresh_interval}s</span>
                    </div>
                  </div>
